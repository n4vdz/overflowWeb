...
function Card({ item, index, handleNavigation }) 
{
  ...
  return (
    ...
    >
      ...
      <h5 className="text-[20px] font-vazir h-2/9 font-semibold text-gray-400 mb-4">
        {item.describe}
      </h5>
      <div className="text-right border-b-3 border-gray-300  h-1/9 items-center pb-20  mb-7">
        <div className="text-deep-blue font-vazir text-lg font-semibold    ">{`${item.teacherName} ●`}</div>
      </div>

      <div className="flex font-kalameh-num flex-row-reverse justify-between ">
        <div className="w-26 h-6 flex justify-between px-1 text-left  bg-gray-300 rounded-4xl ">
